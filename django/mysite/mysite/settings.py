...
SECRET_KEY = 'django-insecure-6zp-)&_o@!b^k(l0x+q_k!ah@$*r@@k22$4tv9^u-!whdgo@d#'
...
# To do this '$ python manage.py migrate', is called.

# The migrate command looks at the INSTALLED_APPS setting 
# and creates any necessary database tables according to the database settings in your mysite/settings.py file 
